...
| ------ | ---------------------------------------------------- | ------------------------------- | ---- | ------- |
| DR-001 | Operating model and responsibility matrix            | Business owner                  | 3.2  | Planned |
...
| DR-008 | Governance ownership and approval workflow           | Business owner                  | 3.2  | Planned |
