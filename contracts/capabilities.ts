...
export const retainedCapabilityCatalogue = [
  {
    ...
    surface: "public",
    authority: "Version-controlled governed content and fail-closed claim publication",
    contractReferences: [
      { name: "public-content.catalogue", version: 1 },
      { name: "public-claims.register", version: 1 },
    ],
    acceptanceFixtureIds: ["PORT-001", "PORT-002", "PORT-021", "PORT-022"],
    activation: "active",
